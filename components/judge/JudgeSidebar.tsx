...
const menuItems = [
  ...
  },
  {
    ...
    icon: Award,
    description: "View my scored submissions",
  },
];
    ...
    <>
      ...
      <div className="flex h-full flex-col">
        ...
        <div className="flex h-16 items-center border-b border-gray-200 px-6">
          <h2 className="text-lg font-semibold text-gray-900">Judge Panel</h2>
        </div>
        ...
        <nav className="flex-1 space-y-1 px-3 py-4">
          {menuItems.map((item) => {
            ...
            const isActive = pathname === item.href || (item.href !== "/judge" && pathname?.startsWith(item.href));
